...
3. Placeholder for project 3.
    + Not sure yet what this project will be, but hopeing to use a documentation metrics analysis from my current job.
...
8. Movie Ratings and Streaming EDA
...
9. Weather Data Extraction and Cleaning
